...
public class Nine_Mens_Morris extends JFrame {
    ...
    void handleHumanClick(Point p) {
        if (humanNeedsToRemovePiece) {
            ...
            {
                JOptionPane.showMessageDialog(this, "must remove an AI piece that is NOT in a mill, unless all AI pieces are in mills.");
            }
            return;
        }
    ...
    class AIPlayer{
        int maxDepth=3;
       Nine_Mens_Morris game;
        
        public AIPlayer(Nine_Mens_Morris game) { this.game = game; }
